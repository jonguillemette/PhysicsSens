 ...
 */
/* Change and adapted by Jayson Dalpé since 2016-03-28*/
...
public class BluetoothLeService extends Service {
    ...
    public BluetoothGatt mBluetoothGatt;  // We use it independantly
    private int mConnectionState = STATE_DISCONNECTED;
    private static BluetoothLeService mInstance; // Singleton
    ...
    private void broadcastUpdate(final String action, final String address, final int status) {
        // Boradcast implement get address, data and status
    ...
    public void disconnect(String address) {
        ...
        if (mBluetoothGatt != null) {
            if (connectionState != BluetoothProfile.STATE_DISCONNECTED) {
                ...
                sendBroadcast(new Intent(Constants.BLE_CONNECTION_TERMINATED));
            } else {
    ...
    public void close() {
        if (mBluetoothGatt != null) {
            ...
            mBluetoothGatt = null;
            sendBroadcast(new Intent(Constants.BLE_CONNECTION_TERMINATED)); // Send back callback for UI management also
        }
    }
    ...
    /**
     * Retrieves the size of the list of the supported GATT services on the connected device. This should be
     * invoked only after {@code BluetoothGatt#discoverServices()} completes successfully.
     *
     * @return A {@code List} of supported services.
     */
    ...
    public static BluetoothGatt getBtGatt() {
        //todo this is null
        return mInstance.mBluetoothGatt;
    }

    /**
     * Waiting on mBusy variable
     *
     * @param i
     * @return
     */
